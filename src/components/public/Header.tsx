  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/95 backdrop-blur-xl border-b border-border shadow-lg" : "bg-transparent border-b border-transparent"}`}>
        <div className="max-w-[1600px] mx-auto px-4 transition-all duration-300">
          <div className="flex h-14 items-center justify-between gap-3 rounded-none">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button 
                size="sm"
                variant="outline" 
                className="h-8 px-2 bg-transparent border border-primary/30 hover:border-primary hover:bg-primary/5 text-primary"
              ...
              {user ? (
                ...
                <Button size="sm" variant="outline" className="h-8 px-3 bg-transparent border border-primary/30 hover:border-primary hover:bg-primary/5 text-primary" onClick={() => navigate("/auth")}>
                  Login
                </Button>
              )}
            </div>
